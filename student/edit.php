...
if(!empty($image)){
  $_SESSION['image']='<div class="text-success">l\'image  a   été modifié </div>';
  $isImageUpdated = true;
}

   if(empty($image)) 
   {
    $_SESSION['image']='<div class="text-success">l\'image n a  pas été modifié </div>';
   ...
   else
   {
    $isImageUpdated = true;
      ...
      if($isImageUpdated &&  $isUploadSuccess === TRUE){
       // if($isImageUpdated){
      $sql="UPDATE student SET firstname='$nom',lastname='$prenom',birth='$date',image='$image' WHERE idstud=$id";
       } else{
        $sql="UPDATE student SET firstname='$nom',lastname='$prenom',birth='$date' WHERE idstud=$id";
      }
    ...
    // }
        ...
        $id=$_GET['id'];
        $sql="SELECT * FROM student WHERE idstud= $id";
        ...
        <div class="row">
         ...
         <form method="POST" action=""  enctype="multipart/form-data">
          <div class="col-sm-12 ">
                ...
                <label form="depart1" class="col-sm-4 col-form-label " style=""><b></b></label>
                    <div class="col-sm-8">
                    <input type="hidden"   name="idstud" id="depart1"  placeholder=""class=" form-control mt-2"style="width:95%;height: 70%;" value="<?php echo htmlspecialchars($row['idstud']); ?>">
                   </div>
            
                    <label form="depart1" class="col-sm-4 col-form-label " style=""><b>Firstname</b></label>
                    <div class="col-sm-8">
                    <input type="text"   name="firstname" id="depart1"  placeholder="nom"class=" form-control mt-2"style="width:95%;height: 70%;" value="<?php echo htmlspecialchars($row['firstname']); ?>">
                   </div>
                   <label form="depart2" class="col-sm-4 col-form-label " style=""><b>Lastname</b></label>
                    <div class="col-sm-8">
                    <input type="text"   name="lastname" id="depart2 " placeholder="prenom"class=" form-control mt-2"style="width:95%;height: 70%;" value="<?php echo htmlspecialchars($row['lastname']); ?>">
                   </div>
                   <label form="depart2" class="col-sm-4 col-form-label " style=""><b>birth</b></label>
                    <div class="col-sm-8">
                    <input type="text"   name="birth" id="depart2 " placeholder="date de naissance"class=" form-control mt-2"style="width:95%;height: 70%;" value="<?php echo htmlspecialchars($row['birth']); ?>">
                   </div>

                   <label for="image">Image:</label>
                    <p><?php echo $image ; ?></p>
                    <div class="col-sm-12">
                    <img src="<?php echo '../images/'.$image;?>" alt="..."style="max-width:200px">
                    </div>
                   <label form="depart2" class="col-sm-4 col-form-label mt-2" style=""><b>Selectionner une autre image</b></label>
                   <div class="col-sm-8">
