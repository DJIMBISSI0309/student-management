...
<div class="col-sm-2 sidebar" style="height: auto; background-color: rgb(9, 5, 26);" id="pa">
    ...
    <div class="">
        ...
        <div class="sideheader text-white mt-2 ms-1 me-md-1 mt-1" style= "background-color:rgba(110, 110, 117, 0.212);"><span class="fa fa-user ms-2"></span><span class="hide ms-3"><a href="../Student/index.php"class="text-decoration-none text-white">student</a></span>
           <span class="fa fa-angle-right ms-5"></span>
        </div>
        <div class="sidecontent">
     
     </div>
     <div class="sideheader text-white ms-1 me-md-1 mt-1" style="background-color:rgba(110, 110, 117, 0.212);"><span class="fa fa-briefcase ms-2"></span><span class="hide ms-3"><a href="index.php"class="text-decoration-none text-white">specialty</a>
...
<div id="contenu" class="col-sm-10  bg-opacity-50"style="height: auto;">
    <div class="container bg-white p-3" style="margin-top: 10px; height: auto;">
        <div class="row">
            ...
            <div class="text-center" style="margin-top: -10px;"><h2><small class="text-primary">specialty</small></h2>
         ...
         <form method="POST" action="insert.php">
          <div class="col-sm-12 ">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="text"   name="namespe" id="depart1"  placeholder="nom"class=" form-control mt-2"style="width:95%;height: 70%;">
                   </div>
                   <label form="depart2" class="col-sm-4 col-form-label " style=""><b>descriptionspe</b></label>
                    <div class="col-sm-8">
                    <input type="text"   name="descriptionspe" id="depart2 " placeholder="description"class=" form-control mt-2"style="width:95%;height: 70%;">
                   </div>
                   <label form="depart2" class="col-sm-4 col-form-label " style=""><b>namedepart</b></label>
                    <div class="col-sm-8">
                    <select id="dep" name="namedepart"class="sel">
                    <?php
                    require 'connect.php';
