...
//verifier si la session active
if(isset($_SESSION['LAST_ACTIVITY'])){
 $timeout= time() - $_SESSION['LAST_ACTIVITY'];
    //verifier si le temps depuis la dernier activite depasse le timeout
...
<div class="col-sm-2 sidebar" style="height: auto; background-color: rgb(9, 5, 26);" id="pa">
    ...
    <div class="">
     ...
     <div class="sideheader text-white ms-1 me-md-1 mt-1"style="background-color:rgba(110, 110, 117, 0.212);"><span class="fa fa-bitcoin me-md-3 ms-2"></span><span class="hide ms-0"><a href="index.php"class="text-decoration-none text-white">department</a></span>
         ...
         <form method="POST" action="insert.php">
          <div class="col-sm-12 ">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="text"   name="namedepart" id="depart1"  placeholder="namedepart"class=" form-control mt-2"style="width:95%;height: 70%;">
                   </div>
                   <label form="depart2" class="col-sm-4 col-form-label " style=""><b>descriptiondepart</b></label>
                    <div class="col-sm-8">
                    <input type="text"   name="descriptiondepart" id="depart2 " placeholder="descriptiondepart"class=" form-control mt-2"style="width:95%;height: 70%;">
                   </div>
