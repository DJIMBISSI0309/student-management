    ...
    require 'connect.php';
    if($_SERVER["REQUEST_METHOD"]=="POST"or isset($_POST['valider'])){
      $id = $_POST['iddepart'] ;
      $namedepart = $_POST['namedepart'] ;
      $descriptiondepart = $_POST['descriptiondepart'] ;
      $sql="UPDATE department SET namedepart='$namedepart',descriptiondepart='$descriptiondepart' WHERE iddepart=$id";
      if($conn->query($sql)===TRUE){
      
          $_SESSION['update_message']=
          '<div class="message alert-success">data updated successfully.</div>';
        ...
        $id=$_GET['id'];
        $sql="SELECT * FROM department WHERE iddepart= $id";
         ...
         <form method="POST" action="">
          <div class="col-sm-12 ">
                ...
                <label form="depart1" class="col-sm-4 col-form-label " style=""><b>name</b></label>
                    <div class="col-sm-8">
                    <input type="hidden"   name="iddepart" id="depart1"  placeholder="iddepart"class=" form-control mt-2"style="width:95%;height: 70%;" value="<?php echo htmlspecialchars($row['iddepart']); ?>">
                   </div>
            
                    <label form="depart1" class="col-sm-4 col-form-label " style=""><b>namedepart</b></label>
                    <div class="col-sm-8">
                    <input type="text"   name="namedepart" id="depart1"  placeholder="namedepart"class=" form-control mt-2" value="<?php echo htmlspecialchars($row['namedepart']); ?>">
                   </div>
                   <label form="depart2" class="col-sm-4 col-form-label " style=""><b>descriptiondepart</b></label>
                    <div class="col-sm-8">
                    <input type="text"   name="descriptiondepart" id="depart2 " placeholder="descriptiondepart"class=" form-control mt-2" value="<?php echo htmlspecialchars($row['descriptiondepart']); ?>">
                   </div>
