...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $sql1="SELECT * FROM administrateur WHERE Email= ?";
...
<?php if(isset($_SESSION['info'])){
    echo '<div class="mb-3">'.  $_SESSION['info'].'</div>';
    unset($_SESSION['info']);
} ?>
<?php if(isset($error)): ?>
...
<?php endif ?>
    ...
    <div class="form-floating mb-3">
    <input type="email" class="form-control" id="email"  placeholder="Enter email" name="email" required style="height:5%">
    ...
    <div class="col-sm-4">
    <p class="mt-3"><b>Deja inscrit  ? </b><a href="login.php" class="btn btn-primary text-decoration-none ms-3">Connectez-vous ici </a></p>
    </div>
    </div>
