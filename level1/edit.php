    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
      $id = $_POST['idlev'] ;
      $desclev = $_POST['desclev'] ;
    
      $sql="UPDATE level1 SET desclev='$desclev' WHERE idlev=$id";
      if($conn->query($sql)==TRUE){
        ...
        $id=$_GET['id'];
        $sql="SELECT * FROM level1 WHERE idlev= $id";
         ...
         <form method="POST" action="">
          <div class="col-sm-12 ">
                ...
                <label form="depart1" class="col-sm-4 col-form-label " style=""><b>name</b></label>
                    <div class="col-sm-8">
                    <input type="hidden"   name="idlev" id="depart1"  placeholder=""class=" form-control mt-2"style="width:95%;height: 70%;" value="<?php echo htmlspecialchars($row['idlev']); ?>">
                   </div>
            
                    <label form="depart1" class="col-sm-4 col-form-label " style=""><b>desclev</b></label>
                    <div class="col-sm-8">
                    <input type="text"   name="desclev" id="depart1"  placeholder="description du niveau"class=" form-control mt-2"style="width:95%;height: 70%;" value="<?php echo htmlspecialchars($row['desclev']); ?>">
                   </div>
