...
<div class="col-sm-2 sidebar" style="height: auto; background-color: rgb(9, 5, 26);" id="pa">
    ...
    <div class="">
     ...
     <div class="sideheader text-white me-md-1 ms-1 mt-1" style="background-color:rgba(110, 110, 117, 0.212);"><span class="fa fa-hourglass-half ms-2"></span><span class="hide ms-3"><a href="index.php"class="text-decoration-none text-white">level1</a></span>
      <span class="fa fa-angle-right ms-5"></span>
    </div>
     <div class="sidecontent">
         <ul type="none">
...
<div id="contenu" class="col-sm-10  bg-opacity-50"style="height: auto;">
    <div class="container bg-white p-3" style="margin-top: 10px; height: auto;">
        <div class="row">
            ...
            <div class="text-center" style="margin-top: -10px;"><h2><small class="text-primary">level</small></h2>
         ...
         <form method="POST" action="insert.php">
          <div class="col-sm-12 ">
                ...
                <div class="form-group row">
                    ...
                    <label form="depart1" class="col-sm-4 col-form-label " style=""><b>desclev</b></label>
                    <div class="col-sm-8">
                    <input type="text"   name="desclev" id="depart1"  placeholder="description niveau"class=" form-control mt-2"style="width:95%;height: 70%;">
                   </div>
