...
<div class="col-sm-2 sidebar" style="height: auto; background-color: rgb(9, 5, 26);" id="pa">
    ...
    <div class="">
     ...
     <div class="sideheader text-white ms-1 me-md-1 mt-1"style="background-color:rgba(110, 110, 117, 0.212);"><span class="fa fa-eyedropper ms-2"></span><span class="hide ms-3"><a href="index.php"class="text-decoration-none text-white">enrollment</a></span>
      <span class="fa fa-angle-right ms-4"></span>
    </div>
     <div class="sidecontent">
...
<div id="contenu" class="col-sm-10  bg-opacity-50"style="height: auto;">
    <div class="container bg-white p-3" style="margin-top: 10px; height: auto;">
        ...
        if(isset( $_SESSION['delete'])){
            echo '<div class="message alert-danger">'.$_SESSION['delete'].'</div>';
